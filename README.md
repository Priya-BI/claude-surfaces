...
**Short version, five sections →** https://priya-bi.github.io/claude-surfaces/claudecode-vs-cowork/ — the costed half only: one shared allowance, a twelve-person seat mix, what can go wrong,
and the side-by-side table. Same source facts, no risk registers or Fabric routes.
...
| `claudecode-vs-cowork.html` | **Source of the excerpt** — sections 01–04 plus the side-by-side table, renumbered 01–05 and given its own front matter. Same Artifact page form. |
